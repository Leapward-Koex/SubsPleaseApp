...
export const SettingsTab = () => {
    ...
    React.useEffect(() => {
        ...
        AsyncStorage.getItem(StorageKeys.UseAutoGeneratedFolderNames).then(
            (enabled) => {
                const parsedEnabled = JSON.parse(enabled ?? 'true') as boolean;
                setUseAutoGenerateFolderNames(parsedEnabled);
            },
        );
        AsyncStorage.getItem(StorageKeys.AutoGeneratedFolderName).then(
            (value) => {
